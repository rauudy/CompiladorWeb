...
const generateSymbolTableHTML = (symbolTable) => {
    return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
...
const symbolTableEndpoint = (req, res) => {
    try {
...
exports.default = symbolTableEndpoint;
//# sourceMappingURL=symbolTableEndpoint.js.map