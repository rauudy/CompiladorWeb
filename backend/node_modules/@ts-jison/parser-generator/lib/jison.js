...
const Lexer      = require('@ts-jison/lexer-generator');
const ebnfParser = require('@ts-jison/ebnf-parser');
...
const HeaderString = `/**
 * parser generated by  @ts-jison/parser-generator ${Jison.version}
...
generator.constructor = function Jison_Generator (grammar, opt) {
    ...
    const template = JsYaml.load(templateText);
    ...
    switch (opt.moduleType) {
        ...
        default:
            code =
                ...
                // + parser.template.Export.replace(/{{NAME}}/g, opt.moduleName || "");
            break;
    }
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  ...
  exports.parse = function () {
    return ${moduleName}.parse.apply(${moduleName}, arguments[0]);
  };
...
lrGeneratorMixin.generateModuleExpr = function generateModuleExpr (opt) {
    ...
    out += "(function(){ // encapsulate parser class, moduleInclude and lexer\n";
    out += moduleCode;
    out += "\n"+this.moduleInclude;
    if (this.lexer && this.lexer.generateModule) { throw Error("HERE");
        out += this.lexer.generateModule(opt);
    }
    out += "return Parser;";
    out += "\n})();";
...
lrGeneratorMixin.generateModuleCode = function generateModuleCode (opt) {
    ...
    const preSubstitution = parser.template.Constructor
                + parser.template.Export.replace(/{{NAME}}/g, opt.moduleName || "");
...
var parser = typal.beget();
  ...
  lrGeneratorMixin.createParser = function createParser () {
    var code = "const [exports, require, JisonParser, JisonLexer] = arguments;\n"
        + this.generateModuleExpr(this.options || {});
    const myExports = {}; if (false) console.log(code)
    new Function(code)(myExports, require, JisonParser, JisonLexer);
