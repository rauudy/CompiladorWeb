...
function JsCalcParser (yy = {}, lexer = new JsCalcLexer(yy)) {
...
// Extends JisonParser
JsCalcParser.prototype = Object.create(JisonParser.prototype);
Object.defineProperty(JsCalcParser.prototype, 'constructor', {
  value: JsCalcParser,
  enumerable: false,
  writable: true
});
...
exports.JsCalcParser = JsCalcParser;

/* generated by ts-jison-lex 0.1.0 */
const { JisonLexer } = require('@ts-jison/lexer');

function JsCalcLexer (yy = {}) {
  this.options = {"moduleName":"JsCalc"};
...
// Extends JisonLexer
JsCalcLexer.prototype = Object.create(JisonLexer.prototype);
Object.defineProperty(JsCalcLexer.prototype, 'constructor', {
  value: JsCalcLexer,
  enumerable: false,
  writable: true
});
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.JsCalcLexer = JsCalcLexer;
